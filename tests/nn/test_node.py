...
class TestNode:
    ...
    def test_given_inputs_when_calculating_output_then_check_output_correctly_calculated(self):
        ...
        actual_output = self.test_node._calculate_output(np.array(self.test_inputs))
        assert actual_output == expected_output

    def test_given_inputs_when_calculating_error_then_check_error_correctly_calculated(self):
        output = self.test_node._calculate_output(np.array(self.test_inputs))
        expected_error = output - self.test_expected_output
    ...
    def test_given_inputs_and_error_when_calculating_delta_w_then_check_delta_w_correctly_calculated(self):
        ...
        actual_delta_w = self.test_node._calculate_delta_w(np.array(self.test_inputs), error)
